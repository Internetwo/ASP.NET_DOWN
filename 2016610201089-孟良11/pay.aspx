<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pay.aspx.cs" Inherits="pay" Title="无标题页" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="style18" colspan="3">
                <asp:Button ID="Button3" runat="server" Text="生成订单" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
