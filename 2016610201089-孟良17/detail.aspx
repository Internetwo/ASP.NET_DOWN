<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="detail.aspx.cs" Inherits="detail" Title="商品详情" Debug="true"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    style="margin-left: 0px" Width="1024px" >
        <Columns>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="style16">
                        ...
                        <tr>
                            <td rowspan="2" align="center">
                                <asp:Image ID="Image2" runat="server" ImageUrl='<%# bind("产品图片") %>' Width="400px" Height="400px" />
                            </td>
                            <td>
